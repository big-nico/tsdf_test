...
if __name__ == "__main__":
    ...
    camera_intrensics = camera.intrinsic_matrix #np.loadtxt("./data/camera-intrinsics.txt", delimiter=' ')
    ...
    for i in range(image_count):
        ...
        color_image = read_rgb("hw2_multiview/rgb/{}_rgb.png".format(i))
        depth_image = read_depth("hw2_multiview/depth/{}_depth.png".format(i))
        camera_pose = cam_view2pose(np.load("hw2_multiview/view_matrix/{}.npy".format(i)))
